...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('admin.edit_testimonial') }}</h1>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                                   id="name_en" name="name_en" value="{{ old('name_en', $testimonial->name['en'] ?? '') }}" required>
                            @error('name_en')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name_ar') is-invalid @enderror"
                                   id="name_ar" name="name_ar" value="{{ old('name_ar', $testimonial->name['ar'] ?? '') }}" required dir="rtl">
                            @error('name_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('role_en') is-invalid @enderror"
                                   id="role_en" name="role_en" value="{{ old('role_en', $testimonial->role['en'] ?? '') }}" required
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('role_ar') is-invalid @enderror"
                                   id="role_ar" name="role_ar" value="{{ old('role_ar', $testimonial->role['ar'] ?? '') }}" required dir="rtl"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('testimonial_en') is-invalid @enderror"
                                      id="testimonial_en" name="testimonial_en" rows="5" required>{{ old('testimonial_en', $testimonial->testimonial['en'] ?? '') }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('testimonial_ar') is-invalid @enderror"
                                      id="testimonial_ar" name="testimonial_ar" rows="5" required dir="rtl">{{ old('testimonial_ar', $testimonial->testimonial['ar'] ?? '') }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @if($testimonial->image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $testimonial->image) }}" alt="{{ __('admin.current_image') }}"
