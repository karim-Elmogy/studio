        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('admin.project_page_settings') }}</h4>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    <form action="{{ route('admin.project-page-settings.update') }}" method="POST">
                        @csrf
                        ...
                        <!-- Scroll Section -->
                        <div class="mb-4">
                            <h5 class="border-bottom pb-2">{{ __('admin.scroll_section') }}</h5>
