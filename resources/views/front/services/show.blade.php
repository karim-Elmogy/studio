    ...
    <main>
                    ...
                    <div class="col-xl-12">
                        <div class="ar-hero-title-box service-5-heading tp_fade_anim mb-80" data-delay=".3">
                            <div class="ar-about-us-4-title-box shape-color d-flex align-items-center mb-20">
                                <span class="tp-section-subtitle pre tp_fade_anim">Web Design</span>
                            ...
                            <h3 class="tp-career-title">Web and mobile <span class="shape-1"><img src="{{asset('front/assets/img/portfolio/portfolio-shape.png')}}" alt=""></span> <br>development</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="tp-service-4-banner-area p-relative">
            <div class="ar-banner-wrap ar-about-us-4">
                <img class="w-100" src="{{asset('front/assets/img/service/service-5/service-5-banner.jpg')}}" alt="" data-speed=".8">
            </div>
        </div>
        <!-- banner area end -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ar-hero-title-box tp_fade_anim" data-delay=".3">
                            ...
                            <h3 class="tp-career-title fs-60 pb-40">We think out of the box <br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="tp-service-4-process-wrapper pl-70 p-relative">
                            <p class="pl-200 mb-50">Our design system energy comes from a natural source <br>
                            ...
                            <div class="tp-service-4-process-thumb fix">
                                <div class="tp_img_reveal">
                                    <img src="{{asset('front/assets/img/service/service-4-thumb-1.png')}}" alt="">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tp-service-5-feature-wrap p-relative">
                            ...
                            <img data-speed=".8" src="{{asset('front/assets/img/service/service-5/service-5-feature.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container container-1230">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tp-service-5-price-heading d-flex align-items-start tp_fade_anim pb-25">
                            <div class="ar-about-us-4-title-box shape-color d-flex align-items-center mb-20">
                                <span class="tp-section-subtitle pre">pricing plans</span>
                                <div class="ar-about-us-4-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="81" height="9" viewBox="0 0 81 9" fill="none">
                                        <rect y="4" width="80" height="1" fill="#fff" />
                                        <path d="M77 7.96366L80.5 4.48183L77 1" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <h3 class="tp-career-title fs-60 pb-40">Profitable <br>
                                pricing plans</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="tp-service-5-price-item-heading">
                                <h4 class="tp-service-5-price-item-title">Branding</h4>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="tp-service-5-price-item-list">
                                <ul>
                                    <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                                                    ...
                                                    </svg></span>Quality Control</li>
                                    <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                                                        <path d="M11 1L4.125 8L1 4.81818" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg></span>Budget Management</li>
                                    <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                                                        <path d="M11 1L4.125 8L1 4.81818" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg></span>Custom design concept</li>
                                    <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                                                        <path d="M11 1L4.125 8L1 4.81818" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg></span>Interior Design</li>
                                    <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                                                        <path d="M11 1L4.125 8L1 4.81818" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg></span>Custom design concept</li>
                                    <li><span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                                                        <path d="M11 1L4.125 8L1 4.81818" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg></span>3D Rendering of proposed design</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3">
                ...
                <div class="tp-service-5-price-item tp_fade_anim">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="tp-service-5-price-item-heading">
                                <h4 class="tp-service-5-price-item-title">UI design</h4>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="tp-service-5-price-item-list">
                ...
                <div class="tp-service-5-price-item tp_fade_anim">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="tp-service-5-price-item-heading">
                                <h4 class="tp-service-5-price-item-title">Research</h4>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="tp-service-5-price-item-list">
