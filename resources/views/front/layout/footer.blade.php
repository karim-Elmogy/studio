...
<footer class="creative-footer-style black-bg-8 p-relative z-index-1">
    ...
    <div class="tp-footer-widget-social">
        @if($footerSettings->footer_facebook)
        <div class="tp_fade_anim" data-delay=".9" data-fade-from="top" data-ease="bounce">
            <a href="{{ $footerSettings->footer_facebook }}" target="_blank" rel="noopener noreferrer">
                            <span>
        ...
        @endif
        @if($footerSettings->footer_twitter)
        <div class="tp_fade_anim" data-delay=".7" data-fade-from="top" data-ease="bounce">
            <a href="{{ $footerSettings->footer_twitter }}" target="_blank" rel="noopener noreferrer">
                            <span>
        ...
        @endif
        @if($footerSettings->footer_dribbble)
        <div class="tp_fade_anim" data-delay=".5" data-fade-from="top" data-ease="bounce">
            <a href="{{ $footerSettings->footer_dribbble }}" target="_blank" rel="noopener noreferrer">
                            <span>
    ...
    <!-- footer area start -->
    <div class="creative-footer-area pt-160 pb-35">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-4 col-lg-4">
                    <div class="tp-footer-widget tp-footer-col-1 pb-40 tp_fade_anim" data-delay=".3">
                        <h4 class="tp-footer-widget-title">{{ $footerSettings->getTranslatedFooterTitle() ?: __('Helping start-ups scale & grow.') }}</h4>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-4 col-md-6">
                    <div class="tp-footer-widget tp-footer-col-2 pb-40 tp_fade_anim" data-delay=".5">
                        <h4 class="tp-footer-widget-title-sm pre mb-25">{{ __('Quick links') }}</h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="tp-footer-widget tp-footer-col-3 pb-40 mb-30 tp_fade_anim" data-delay=".7" data-on-scroll="3">
                        <h4 class="tp-footer-widget-title-sm pre mb-20">{{ __('Contact') }}</h4>
                        <div class="tp-footer-widget-info">
                            @if($footerSettings->footer_email)
                            <a href="mailto:{{ $footerSettings->footer_email }}">{{ $footerSettings->footer_email }}</a>
                            @endif
                            @if($footerSettings->footer_phone)
                            <a href="tel:{{ str_replace([' ', '(', ')', '-'], '', $footerSettings->footer_phone) }}">{{ $footerSettings->footer_phone }}</a>
                            @endif
                        </div>
